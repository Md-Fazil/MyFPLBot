...
const parseUserDetails = (managerid) => {
    return getUserBasicInformation(managerid).then(data => {
        ...
        for(let i = 0; i < leagues.length; i++) {
            ...
            details += `${i + 1}. ${currentLeague.name} - ${currentLeague.entry_rank}`;
...
module.exports = {parseCurrentGameweekFixtures, parseLeagueDetails, parseMyTeam};
